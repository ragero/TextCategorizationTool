    ...
    public static void main(String args[]) {
        ...
        if(args.length > 0){
            try{
                ...
                }else if(config.getClass().getName().equals("TCTConfigurations.UnsupervisedLearning.Configuration_Unsupervised_VSM")) {
                ...
                }else if(config.getClass().getName().equals("TCTConfigurations.UnsupervisedLearning.Configuration_Unsupervised_Network")) {
