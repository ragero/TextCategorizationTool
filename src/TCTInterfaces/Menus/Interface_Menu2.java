...
import TCTInterfaces.Clustering.Interface_Menu_Network;
import TCTInterfaces.Clustering.Interface_Menu_VSM;
import TCTInterfaces.Clustering.Interface_Menu_DimensionalityReductionAnalysis;
import TCTInterfaces.Clustering.Interface_Menu__Structuring_Results;
...
public class Interface_Menu2 extends javax.swing.JFrame {
    ...
    Configuration_Unsupervised_VSM configurationUnsupervisedVSM;
    Configuration_Unsupervised_Network configurationUnsupervisedNetwork;
    ...
    public Interface_Menu2() {
        ...
        configurationUnsupervisedVSM = new Configuration_Unsupervised_VSM();
        configurationUnsupervisedNetwork = new Configuration_Unsupervised_Network();
    ...
    private void initComponents() {
        ...
        mUnsupervised = new javax.swing.JMenu();
        mClustering = new javax.swing.JMenu();
        iVSM = new javax.swing.JMenuItem();
        iNetwork = new javax.swing.JMenuItem();
        ...
        mUnsupervised.setText("Unsupervised Learning      ");
        mUnsupervised.setFont(new java.awt.Font("DejaVu Sans", 0, 24)); // NOI18N

        mClustering.setText("Unsupervised Clustering");
        mClustering.setFont(new java.awt.Font("DejaVu Sans", 0, 21)); // NOI18N

        iVSM.setFont(new java.awt.Font("DejaVu Sans", 0, 18)); // NOI18N
        iVSM.setText("Vector Space Model");
        iVSM.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                iVSMActionPerformed(evt);
            }
        });
        mClustering.add(iVSM);

        iNetwork.setFont(new java.awt.Font("DejaVu Sans", 0, 18)); // NOI18N
        iNetwork.setText("Network Model");
        iNetwork.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                iNetworkActionPerformed(evt);
            }
        });
        mClustering.add(iNetwork);

        mUnsupervised.add(mClustering);

        jMenu13.setFont(new java.awt.Font("DejaVu Sans", 0, 21)); // NOI18N
        jMenu13.setText("Structuring Results");
        jMenu13.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenu13ActionPerformed(evt);
            }
        });
        mUnsupervised.add(jMenu13);

        jMenu14.setFont(new java.awt.Font("DejaVu Sans", 0, 21)); // NOI18N
        jMenu14.setText("Dimensionality Reduction Analysis");
        jMenu14.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenu14ActionPerformed(evt);
            }
        });
        mUnsupervised.add(jMenu14);

        jMenuBar1.add(mUnsupervised);
    ...
    private void jMenu13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenu13ActionPerformed
        JInternalFrame frame = new Interface_Menu__Structuring_Results();
        dDesktop.add(frame);
        try {
            frame.setSelected(true);
        } catch (PropertyVetoException ex) {
    ...
    private void jMenu14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenu14ActionPerformed
        JInternalFrame frame = new Interface_Menu_DimensionalityReductionAnalysis();
        dDesktop.add(frame);
        try {
            frame.setSelected(true);
        } catch (PropertyVetoException ex) {
    ...
    private void iVSMActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_iVSMActionPerformed
        JInternalFrame frame = new Interface_Menu_VSM(configurationUnsupervisedVSM);
        dDesktop.add(frame);
        try {
            frame.setSelected(true);
        } catch (PropertyVetoException ex) {
    ...
    }//GEN-LAST:event_iVSMActionPerformed

    private void iNetworkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_iNetworkActionPerformed
        JInternalFrame frame = new Interface_Menu_Network();
        dDesktop.add(frame);
        try {
            frame.setSelected(true);
        } catch (PropertyVetoException ex) {
    ...
    }//GEN-LAST:event_iNetworkActionPerformed
 ...
 /*java.awt.EventQueue.invokeLater(new Runnable() {
    ...
    private javax.swing.JMenuItem iNetwork;
    private javax.swing.JMenuItem iVSM;
    ...
    private javax.swing.JMenu mClustering;
    ...
    private javax.swing.JMenu mUnsupervised;
