...
public class Email implements Serializable{
    ...
    public static void emailInterface(ConfigurationBase configuration){
        int retorno = JOptionPane.showConfirmDialog(null, "Before saving the configuration, do you want to receive an e-mail when the experimente are complete?", "TCT", JOptionPane.YES_OPTION);
